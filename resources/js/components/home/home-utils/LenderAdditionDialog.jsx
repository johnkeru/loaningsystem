...
export default function LenderAdditionDialog({ title }) {
    ...
    const handleLend = ({ amount, interest }, { setErrors }) => {
        axios
            ...
            .then((res) => {
                ...
                notifySuccess(`You have successfully lent additional money!`);
                dispatch(update_lender(respo.lender));
